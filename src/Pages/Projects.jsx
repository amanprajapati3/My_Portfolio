      ...
      <div className="bg-[url('https://wallpapers.com/images/hd/light-color-background-vmkuihk29pi1xq65.jpg')] bg-cover bg-center md:pt-5 pt-16 px-5 pb-20">
        ...
        <Carousel responsive={responsive} className=" rounded-xl p-2 mx-5 border-2 border-gray-300 my-5"  >
          <div className="bg-white rounded-xl hover:shadow-2xl hover:shadow-gray-500 transition-all duration-200 text-center mx-3 md:mx-8 mt-3">
            <img src="/Blog_img.png" className="p-1 rounded-xl h-64" alt="" />
          ...
          <div className="bg-white rounded-xl hover:shadow-2xl hover:shadow-gray-500 transition-all duration-200 text-center mx-3 md:mx-8 mt-3">
            <img src="/myntra_img.png" className="p-1 rounded-xl h-64" alt="" />
          ...
          <div className="bg-white rounded-xl hover:shadow-2xl hover:shadow-gray-500 transition-all duration-200 text-center mx-3 md:mx-8 mt-3">
            <img src="/jarvis_img.png" className="p-1 rounded-xl h-64 w-full" alt="" />
          ...
          <div className="bg-white rounded-xl hover:shadow-2xl hover:shadow-gray-500 transition-all duration-200 text-center mx-3 md:mx-8 mt-3">
            <img src="/full_stack_blog.png" className="p-1 rounded-xl h-64" alt="" />
          ...
          <div className="bg-white rounded-xl hover:shadow-2xl hover:shadow-gray-500 transition-all duration-200 text-center mx-3 md:mx-8 mt-3">
            <center>
            <img src="/calculator_img.png" className="p-1 rounded-xl h-64" alt="" />
            </center>
          ...
          <div className="bg-white rounded-xl hover:shadow-2xl hover:shadow-gray-500 transition-all duration-200 text-center mx-3 md:mx-8 mt-3">
            <img src="/todo_img.png" className="p-1 rounded-xl h-64" alt="" />
